  ...
  <div class="church-con">
    <div class="title">
      <div class="title-left">
        <div class="titlt-left-top">
          <div class="title-name fontSize18 weight700">洋坑基督教堂</div>
    ...
    <div class="bnts">
      <div class="btn" @click="openLocation">
        <van-image
          ...
          width="30"
          height="30"
          src="/images/icon001.jpg"
        />
        <div class="btn-name weight700 textHide1">一键导航</div>
      </div>
      <div class="btn" @click="telShow = true">
        <van-image
          ...
          width="30"
          height="30"
          src="/images/icon002.jpg"
        />
        <div class="btn-name weight700 textHide1">
          一键拨号<span class="blueColor"></span>
        </div>
      </div>
    </div>
    <!-- 信息块 -->
    <van-collapse v-model="activeNames">
      <van-collapse-item title="基本信息" name="1">
        <div class="block-con hasColor1 fontSize12">
          <div class="block-line">
            <div class="block-line-left">所属机构：甄海区 泽雅镇</div>
      ...
      <van-collapse-item title="关联活动" name="2">
        <div class="block-con hasColor1 fontSize12">
          <div class="block-line">
            <div class="block-line-left">备案1：甄海区 泽雅镇</div>
            <div class="block-line-right"></div>
          </div>
          <div class="block-line">
            <div class="block-line-left">备案2：甄海区 泽雅镇</div>
            <div class="block-line-right"></div>
          </div>
        </div>
      </van-collapse-item>
      <van-collapse-item title="教职人员" name="3">
        <div class="block-con hasColor1 fontSize12">
          <div class="block-line">
            <div class="block-line-left">第一责任人：甄海区 泽雅镇</div>
            <div class="block-line-right"></div>
          </div>
          <div class="block-line">
            <div class="block-line-left">第二主任人：甄海区 泽雅镇</div>
            <div class="block-line-right"></div>
          </div>
          <div class="block-line">
            <div class="block-line-left">关联教职人员：甄海区 泽雅镇</div>
            <div class="block-line-right"></div>
          </div>
        </div>
      </van-collapse-item>
      ...
      <van-collapse-item title="三人驻堂" name="4">
        <div class="block-con hasColor1 fontSize12">
          ...
          <div class="block-line">
            <div class="block-line-left">组员：甄海区 泽雅镇</div>
            <div class="block-line-right"></div>
          </div>
          <div class="block-line">
            <div class="block-line-left">组员：甄海区 泽雅镇</div>
