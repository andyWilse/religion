<template>
	<div class="page">
		<van-button type="primary" size="small" @click="screenImage()">截图</van-button>
		<div ref="imageTofile" style="background-color: #F6F6F6;">
		<van-search 
			v-model="searchName" 
			background="#F6F6F6" 
	...
	export default {
		...
		methods: {
			...
			screenImage() {
				...
				// 	useCORS: true
				// }
				html2canvas(canvasBox, canvas).then((canvas) => {
