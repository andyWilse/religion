<template>
	<div class="page">
		<van-search v-model="searchName" background="#F6F6F6" placeholder="输入场所名称、设备编码查询" @focus="
        $router.push({ path: '/monitor/search', query: { source: 'search' } })
      " />
		<div class="title fontSize12 weight700">茶山街道 - 王某某</div>
		<div class="typeList marginTop10">
			<van-badge content="85例" color="#2C9A35">
				<div class="type-block" @click="tableIndex = 1">
			...
			<van-badge content="584例" color="#9A7A19">
				<div class="type-block" @click="tableIndex = 2">
			...
			<van-badge content="19例" color="#3D1C9A">
				<div class="type-block" @click="tableIndex = 3">
					<!--   -->
		...
		<alerts-list :tableIndex="tableIndex" />
...
<script>
	import alertsList from "@/views/Alerts/Alerts.vue";
