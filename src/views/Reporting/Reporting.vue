      ...
      <van-tab title="数据汇总 ">
        ...
        <div class="ledger">
          ...
          <van-tabs
            ...
            line-height="1px"
            line-width="0px"
            title-active-color="#9B2E25"
          >
            <van-tab title="全部">
              <!-- 火灾预警 -->
              <div
                class="ledger_div_contain"
              ...
              >
                <div class="ledger_left">
                  <img
                    src="@/assets/imagee.jpg"
                    class="ledger_left_img"
                    @click.stop="
                      $ImagePreview([require('@/assets/imagee.jpg')])
                    "
                  />
                </div>
                <!-- 文字 -->
