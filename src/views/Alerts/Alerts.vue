<template>
	<div class="container">
		...
		<div class="alerts_inpt">
			<!-- 输入框 -->
			<div class="alerts_in">
				<van-search class="int" v-model="value" shape="round" placeholder="请输入搜索关键词" size="small" />
			...
			<div class="earlyWarning">
				<div class="earlyWarning_onde">
					...
					<div class="earywarning_log_two">
						<van-button square type="primary" size="small" class="vbtn">人脸</van-button>
						<van-button square type="primary" size="small" class="vbtn">人流</van-button>
						<van-button square type="primary" size="small" class="vbtn">火灾</van-button>
					</div>
				</div>
				<!-- 数据可视化图 -->
			...
			<div class="earlyWarning_events">
				<div class="earlyWarning_events_onde">
					...
					<div class="earlyWarning_events_two">
						<van-button square type="primary" size="small" class="vbtn">日</van-button>
						<van-button square type="primary" size="small" class="vbtn">周</van-button>
						<van-button square type="primary" size="small" class="vbtn">月</van-button>
					</div>
				</div>
				<!-- 数据可视化图 -->
